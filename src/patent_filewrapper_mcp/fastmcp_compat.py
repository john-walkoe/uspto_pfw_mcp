...
fetched on demand. Three are eager (`PFW_search_applications_minimal`,
`PFW_get_guidance`, `PFW_get_application_documents`); the rest are deferred.
That split is where this server's context savings come from, and it is
advertised in SERVER_INSTRUCTIONS.
